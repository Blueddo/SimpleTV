...
-------------------------------------
    local function ExampleCurrentIcons(iconset_name)
            ...
            local t_exam = {"00.png", "01.png", "08.png" , "15.png", "18.png", "19.png", "20.png", "23.png", "26.png", "27.png", "31.png", "32.png"}
             local path = Weather.FullDir_UTF8 ..  weather_core.GetIconsetPath(iconset_name)
             for k, v in pairs(t_exam) do
                       --example_img= escape(example_img)
...
local function OnNavigate()
  
local val = m_simpleTV.Dialog.ExecScriptParam(Object,"GetGeo()") --sync, with return value
m_simpleTV.OSD.ShowMessage_UTF8(val)
end
function OnNavigateComplete(Object)
    ...
    Weather.Param.xp = (Weather.SimpleVersion >= 800) and 0 or Weather.xp
...
-- показывать время
    ...
    m_simpleTV.Dialog.SetCheckBoxValue(Object,'showtempletter',Weather.Param.showtempletter or 1) 
    m_simpleTV.Dialog.SetCheckBoxValue(Object,'round',Weather.Param.round or 0) 
-- иконку 
...
-- показывать время
   ...
   Weather.Param.showtempletter = m_simpleTV.Dialog.GetCheckBoxValue(Object,'showtempletter') or Weather.Param.showtempletter or 1
   Weather.Param.round = m_simpleTV.Dialog.GetCheckBoxValue(Object,'round') or Weather.Param.round or 0								 
